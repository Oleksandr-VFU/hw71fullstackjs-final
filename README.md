...
Це повнофункціональний fullstack додаток для автосалону з продажу та обслуговування сучасних електромобілів (**automarket**), створений на основі фінального проекту з React JS. Проект було перероблено для використання **Express.js + Mongoose** замість MockAPI, що забезпечує оптимізовану взаємодію з **MongoDB Atlas** та повноцінну інтеграцію backend з frontend.
